...
export function ProcessSection() {
  return (
    <section id="process" className="pb-20 md:pb-24" aria-labelledby="process-section-title">
      <div className="container-shell">
        <div className="relative overflow-hidden rounded-3xl border border-border/75 bg-surface/60 p-6 shadow-panel backdrop-blur-xl sm:p-8 md:p-10 lg:p-12">
          ...
          <motion.div
            aria-hidden="true"
            className="pointer-events-none absolute -right-24 top-8 h-60 w-60 rounded-full bg-primary/20 blur-3xl"
          ...
          <div className="relative">
            ...
            >
              {processSectionConfig.supportingText}
            </motion.p>
