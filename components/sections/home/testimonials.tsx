...
export function TestimonialsSection() {
  return (
    <section id="testimonials" className="pb-20 md:pb-24" aria-labelledby="testimonials-section-title">
      <div className="container-shell">
        <div className="relative overflow-hidden rounded-3xl border border-border/75 bg-surface/60 p-6 shadow-panel backdrop-blur-xl sm:p-8 md:p-10 lg:p-12">
          ...
          <motion.div
            aria-hidden="true"
            className="pointer-events-none absolute -left-24 top-10 h-56 w-56 rounded-full bg-primary/20 blur-3xl"
          ...
          <div className="relative">
            ...
            >
              {testimonialsSectionConfig.label}
            </motion.p>
            ...
            >
              {testimonialsSectionConfig.headline}
            </motion.h2>
            ...
            >
              {testimonialsSectionConfig.supportingText}
            </motion.p>
